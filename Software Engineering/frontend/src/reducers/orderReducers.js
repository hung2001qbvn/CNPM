...
export const orderStaffListReducer = (state = {orders:[]},action) => {
    switch(action.type) {
        case ORDER_STAFF_LIST_REQUEST:
            return {loading: true};
        case ORDER_STAFF_LIST_SUCCESS:
            return {loading: false, orders: action.payload};
        case ORDER_STAFF_LIST_FAIL:
            return {loading: false, error: action.payload};
        default:
            return state;
    }
...
export const orderStaffListRemoveReducer = (state = {order:{}},action) => {
    switch(action.type) {
        case ORDER_STAFF_LIST_REMOVE_REQUEST:
            return {loading: true};
        case ORDER_STAFF_LIST_REMOVE_SUCCESS:
            return {loading: false, order: action.payload};
        case ORDER_STAFF_LIST_REMOVE_FAIL:
            return {loading: false, error: action.payload};
        default:
            return state;
    }
